...
public class Tes {
    ...
    static int jamLembur, uangTransport = 100000, bpjsKesehatan = 115000, bpjsKetenagakerjaan = 85000, jmlh;
    ...
    static void identitasPegawai() {
        ...
        jmlh = sc.nextInt();
        tabel = new String[jmlh][4];

        for(int l = 0; l < jmlh; l++) {
            System.out.print("Masukkan Nama Pegawai\t\t : ");
        namaPegawai = sc.nextLine();
        tabel[l][0] = namaPegawai;
        namaPegawai = sc.nextLine();
        tabel[l][0] = namaPegawai;
        ...
        if(pilihanStatus.equalsIgnoreCase("Kontrak") || pilihanStatus.equalsIgnoreCase("Full Timer")) {
    ...
    static void outputIdentitasPegawai() {
        ...
        for(int x = 0; x < tabel.length; x++) {
            for(int y = 0; y < tabel[0].length; y++) {
